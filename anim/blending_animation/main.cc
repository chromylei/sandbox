...
class MainDelegate : public azer::WindowHost::Delegate {
 public:
  ...
  virtual void OnUpdateScene(double time, float delta_time) {
    ...
    std::vector<HardwareSkinnedMesh::AnimBlending> blending;
    blending.push_back(HardwareSkinnedMesh::AnimBlending("Aim", 0.5));
    blending.push_back(HardwareSkinnedMesh::AnimBlending("Walk", 0.5));
    mesh_.Update(blending, time);
    // mesh_.Update("Walk", time);
  }
